...
var Mouse = function () {
  ...
  _createClass(Mouse, [{
    ...
    key: "_fireOverEvent",
    value: function _fireOverEvent(event) {
    ...
    key: "_fireOutEvent",
    value: function _fireOutEvent(event) {
    ...
    key: "_fireDownEvent",
    value: function _fireDownEvent(event) {
    ...
    key: "_fireUpEvent",
    value: function _fireUpEvent(event) {
    ...
    key: "_fireMoveEvent",
    value: function _fireMoveEvent(event) {
    ...
    key: "_fireScrollEvent",
    value: function _fireScrollEvent(event) {
    ...
    key: "_fireDragEvent",
    value: function _fireDragEvent(event) {
    ...
    key: "_fireDragOverEvent",
    value: function _fireDragOverEvent(event) {
    ...
    key: "_fireDropEvent",
    value: function _fireDropEvent(event) {
    ...
    key: "_fireStopEvent",
    value: function _fireStopEvent(event) {
    ...
    key: "_fireClickEvent",
    value: function _fireClickEvent(event) {
    ...
    value: function detachFromElement() {
